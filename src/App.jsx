...
function App() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-main bg-[center_bottom_200px] md:bg-center bg-no-repeat bg-black">
            ...
            <div className="flex">
              {/* <div><div className="border-l-2 border-red-500 h-[20px]"></div></div> */}
                <div className="px-3 text-gray-300">
                  <Link to="/qualified">My NFT's</Link>
                </div>
              <div><div className="border-l-2 border-red-500 h-[20px]"></div></div>
                <div className="px-3 text-gray-300">
